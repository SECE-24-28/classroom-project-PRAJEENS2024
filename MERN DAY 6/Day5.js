...
// let aa = {"name":"Hello","roll": 34,"roll":45}
// console.log(aa)
// console.log(Object.keys(aa))
// console.log(Object.values(aa))
// aa["address"]= "Coimbatore"
// console.log(aa)
// aa["address"]= "Tamil Nadu"
// console.log(aa)
// // Reverse Key Value
// // {h:[hello,hii],b:[bangalore,bye]}
 //let ar = ["hello","hi","bangalore","bye"]
// b={}
// c={}
// for(let [k,v] of Object.entries(ar)){
//     b[v] = k
//     c[k] = v
...
//if Object.values(ar)[0] = Object
// ar1 = ['hel',"hil","bangalore","bye"]
// e = {}
// for(let m of ar1){
//     e[m.length] = e[m.length]||[]
//     e[m.length].push(m)
// }
//console.log(e)
f = {}
let word = "ababcdabddkb" //dfgdswy
for( let y of word){
    f[y] = f[y]|| 0
    f[y]+=1
}
